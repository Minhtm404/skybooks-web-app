      ...
      <div className="mx-40 px-5 py-3 grid grid-cols-4">
        ...
        <div className="col-span-3 mb-3">
          ...
          <div className="text-justify text-sm text-gray-900 space-y-2">
            <p>
              After nearly two decades of development, our Skybooks Stores are now a chain
              of stores, covering the capital city of Hanoi, the ancient coastal village
              of Hoi An in the central of Vietnam, and Ho Chi Minh City, where you can
              find books on Vietnam in foreign languages and souvenirs from Vietnam.
            </p>
            <p>
              Apart from being a large distributor of foreign languages books on Vietnam,
              Skybooks is also the official distributor of the world famous publishers
              i.e. Cambridge, Cengage, Elsevier, John Wiley, Pearson, McGraw-Hill,
              Macmillan, Springer, Hachette, Penguin, Random House, Simon& Schuster,
              Wordsworth, Phaidon, Taschen, Page One, APD, Berkeley…
            </p>
            <p>
              The individual clients are always our important sector, however, Skybooks is
              proud to be the long term supplier for the Universities, Research
